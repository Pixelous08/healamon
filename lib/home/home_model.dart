...
class HomeModel extends FlutterFlowModel<HomeWidget> {
  ...
  // State field(s) for searchsymptom widget.
  final searchsymptomKey = GlobalKey();
  FocusNode? searchsymptomFocusNode;
  ...
  @override
  void dispose() {
    searchsymptomFocusNode?.dispose();
  }

  /// Action blocks.
  Future querysearch(BuildContext context) async {}
}
